    ...
    return (
        <View style={{ marginTop: 32, flex: 1 }}>
            <ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}>
                <ProductDetailHeader title="abc" />
                <View style={[style.body]}>
                    <View style={[style.contentBody]}>
                        <View style={[style.rowCenterCenter, style.outline, {
                        ...
                        <Text style={[style.headerText, { marginTop: 8 }]}>Headphone</Text>
                        <View style={[style.centerContainer, style.rowCenterBetween]}>
                            <Text style={[style.priceText, { marginTop: 8 }]}>12300$</Text>
                            <View style={[style.rowCenter]}>
                                <View style={{ flexDirection: "row" }}>
                                    <Star width={20} height={20} />
                                    <Text style={{ fontWeight: "bold", fontSize: 16 }}>4.5</Text>
                                </View>
                                <Text style={{ fontWeight: "medium", fontSize: 16, color: colors.secondText }}>(99 reviews)</Text>
                            </View>
                        </View>
                        ...
                        <View>
                            <Text style={[style.headerText, { fontSize: 16, color: colors.mainText }]}>Description</Text>
                            <Text style={[{ marginBottom: 8, paddingVertical: 16 }]}>{
                                `This is a headphonasdkjhasdkahskjdhask
jdhkhsdkhqwiudhiuqwhdiuhqwiudhiqw
lkajsd
asd;lk;lasd;lajasd
aksjhdkjahsdwqd hduihasihdiahsdiuhasiudh
lasjdlasjdlkasjdlkjasldk
askjdlkqjwdlkjqwoidjhe`
                            }</Text>
                        </View>
                        ...
                        <View style={{ gap: 8 }}>
                            <View style={[style.rowCenter]}>
                                <View style={[style.rowCenter, { width: "50%" }]}>
                                    ...
                                    <Text
                                        style={[style.headerText, { fontSize: 12, color: colors.secondText }]}
                                    >
                                        Express
                                    </Text>
                                </View>
                        ...
                        <View style={{ gap: 16 }}>
                            <View style={[style.rowCenterBetween]}>
                                <Text style={[style.headerText, { fontSize: 16, color: colors.mainText }]}>Reviews</Text>
                                <Pressable onPress={toggleModalReviews} style={[style.rowCenter]}>
                                    <Text style={{ color: colors.secondText, fontWeight: "medium" }}>See all</Text>
                            ...
                            <View style={[style.rowCenterBetween, { gap: 16 }]}>
                                <View style={{ gap: 8 }}>
                                    <View style={[style.rowCenter]}>
                                        <Text style={{ fontWeight: "bold", fontSize: 16 }}>4.5/5</Text>
                                    </View>
                                    <Text style={{ fontWeight: "medium", fontSize: 16, color: colors.secondText }}>(99 reviews)</Text>
                                ...
                                <View style={{ flex: 1 }} >
                                    <View style={[style.rowCenter]}>
                                        <View style={{ flex: 1, height: 6 }}>
                                            <View style={{ width: "100%" }}>
                                                <View style={{ width: "100%", height: 6, backgroundColor: colors.rateLine, borderRadius: 8 }} />
                                                <View style={{ position: "relative", top: -6, borderRadius: 8, width: "80%", height: 6, backgroundColor: colors.rateStar }} />
                                            </View>
                                        </View>
                                        <Text>5</Text>
                                    </View>
                                    <View style={[style.rowCenter]}>
                                        <View style={{ flex: 1, height: 6 }}>
                                            <View style={{ width: "100%" }}>
                                                <View style={{ width: "100%", height: 6, backgroundColor: colors.rateLine, borderRadius: 8 }} />
                                                <View style={{ position: "relative", top: -6, borderRadius: 8, width: "44%", height: 6, backgroundColor: colors.rateStar }} />
                                            </View>
                                        </View>
                                        <Text>4</Text>
                                    </View>
                                    <View style={[style.rowCenter]}>
                                        <View style={{ flex: 1, height: 6 }}>
                                            <View style={{ width: "100%" }}>
                                                <View style={{ width: "100%", height: 6, backgroundColor: colors.rateLine, borderRadius: 8 }} />
                                                <View style={{ position: "relative", top: -6, borderRadius: 8, width: "33%", height: 6, backgroundColor: colors.rateStar }} />
                                            </View>
                                        </View>
                                        <Text>3</Text>
                                    </View>
                                    <View style={[style.rowCenter]}>
                                        <View style={{ flex: 1, height: 6 }}>
                                            <View style={{ width: "100%" }}>
                                                <View style={{ width: "100%", height: 6, backgroundColor: colors.rateLine, borderRadius: 8 }} />
                                                <View style={{ position: "relative", top: -6, borderRadius: 8, width: "22%", height: 6, backgroundColor: colors.rateStar }} />
                                            </View>
                                        </View>
                                        <Text>2</Text>
                                    </View>
                                    <View style={[style.rowCenter]}>
                                        <View style={{ flex: 1, height: 6 }}>
                                            <View style={{ width: "100%" }}>
                                                <View style={{ width: "100%", height: 6, backgroundColor: colors.rateLine, borderRadius: 8 }} />
                                                <View style={{ position: "relative", top: -6, borderRadius: 8, width: "12%", height: 6, backgroundColor: colors.rateStar }} />
                                            </View>
                                        </View>
                                        <Text>1</Text>
                                    </View>
            ...
            <View style={[style.rowCenter, { paddingVertical: 4, paddingHorizontal: 16 }]}>
                ...
                <Pressable style={[style.outline, { padding: 8, borderColor: colors.brand }]}>
                    <Favorite width={20} height={20} />
                </Pressable>
                <Button
                    style={[style.outline, { borderColor: colors.brand, flex: 1 }]}
