        ...
        <View style={[style.body]}>
          <View style={[style.contentBody]}>
            ...
            >
              <Image
                source={{
                  uri: "https://loremflickr.com/640/480?lock=6365946044219392",
                }}
                width={336}
                height={216}
                alt="product"
...
askjdlkqjwdlkjqwoidjhe`}</Text>
              ...
              <View style={[style.rowCenter]}>
                <View style={[style.rowCenter, { width: "50%" }]}>
                  ...
                  <Text
                    style={[
                      style.headerText,
                      { fontSize: 12, color: colors.secondText },
                    ]}
                  >
                    Express
                  </Text>
            ...
            <View style={{ gap: 16 }}>
              <View style={[style.rowCenterBetween]}>
                ...
                >
                  <Text
                    style={{ color: colors.secondText, fontWeight: "medium" }}
                  >
                    See all
                  </Text>
                      ...
                      <View style={{ width: "100%" }}>
                        <View
                          style={{
                            width: "100%",
                            height: 6,
                            backgroundColor: colors.rateLine,
                            borderRadius: 8,
                          }}
                        />
                        <View
                          style={{
                            ...
                            width: "80%",
                            height: 6,
                            backgroundColor: colors.rateStar,
                          }}
                        />
                      </View>
                    </View>
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      <View style={[style.rowCenterBetween]}>
                        ...
                        <Text
                          style={{ fontSize: 12, color: colors.secondText }}
                        >
                          1 day ago
                        </Text>
                      </View>
      ...
      >
        <Pressable
          ...
          style={[style.outline, { padding: 8, borderColor: colors.brand }]}
        >
